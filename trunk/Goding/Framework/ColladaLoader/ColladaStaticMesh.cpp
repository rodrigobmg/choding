...
void ColladaStaticMesh::processVisualScenes( MeshManager* Meshes )
{
...
vector<string> ColladaStaticMesh::processStringSource( daeElement* source )
{
...
void ColladaStaticMesh::processGeometries( MeshManager* Meshes )
{
	//Foreach Static Mesh...
...
MeshManager* ColladaStaticMesh::Load( string filename )
{
	//Output object
