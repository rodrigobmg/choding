...
bool RendererDX9::Create( HWND hWnd )
{
	...
	m_RenderFrameList = RenderFramePtr( new RenderFrame );

	return true;
}

void RendererDX9::RenderFrame( float fAccumtime )
{	
	if ( m_bWireMode )
...
void RendererDX9::drawAxis(  D3DXMATRIX& mat , D3DXVECTOR3& point , ID3DXLine* Line )
{
...
void RendererDX9::drawBox( D3DXMATRIX& mat , D3DXVECTOR3& minPos , D3DXVECTOR3& maxPos , ID3DXLine* Line )
{
	D3DXVECTOR3 lineLBN[2];
	lineLBN[0] = minPos;
...
void RendererDX9::DrawBox( D3DXMATRIX& mat , D3DXVECTOR3& minPos , D3DXVECTOR3& maxPos )
{
	BOXDATA token( mat , minPos , maxPos );
	m_listBoxData.push_back( token );
}

void RendererDX9::DrawAxis( D3DXMATRIX& mat , D3DXVECTOR3& point )
{
	AXISDATA token( mat , point );
	m_listAxisData.push_back( token );
}

void RendererDX9::drawEtc()
{
