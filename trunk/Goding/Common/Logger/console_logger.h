...
namespace util
{
	...
	public:
		...
		void WriteMsg(wchar_t const* msg, uint32 len=0xffffffff);
		void WriteMsg(char const* msg, uint32 len=0xffffffff);
	...
	private:
		...
		void vWriteMsg(wchar_t const* msg, uint32 length);
		void vWriteMsg(char const* msg, uint32 length);
		void vWriteDepth();
		void vClear();
