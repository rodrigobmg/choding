#ifndef _SNOWBOARD_FRAMEWORK_SYSTEM_FRAMEMEMORY_H_
#define _SNOWBOARD_FRAMEWORK_SYSTEM_FRAMEMEMORY_H_
...
#define FRAMEMEMORY	singleton_holder< GdsFrameMemory , create_using_tls >::instance()
