...
public:
	...
	*/
	...
	const TIXML_STRING& GetString() const { return value; }
...
public:
	...
	*/
	...
	int QueryByteValue(BYTE* _value) const; 
...
public:
	...
	*/
	...
	/*
	 This is - in theory - a bug fix for "QueryValueAtribute returns truncated TIXML_STRING"
	...
	*/
	...
	const TIXML_STRING* Attribute( const TIXML_STRING& name, float* f) const; 
	const TIXML_STRING* Attribute( const TIXML_STRING& name, BYTE* bt) const; 
	const TIXML_STRING* Attribute( const TIXML_STRING& name, bool* b) const; 
	...
	int QueryFloatAttribute( const TIXML_STRING& name, float* _value) const; 
	int QueryByteAttribute( const TIXML_STRING& name, BYTE* _value) const; 
	int QueryBoolAttribute( const TIXML_STRING& name, bool* _value) const; 
	...
	void SetAttribute( const TIXML_STRING& name, float _value); 
	void SetAttribute( const TIXML_STRING& name, BYTE _value); 
	void SetAttribute( const TIXML_STRING& name, bool _value); 
	...
	*/
	...
	void SetText(const TIXML_STRING& strText); 
...
public:
	...
	*/
	bool LoadFile(const char* pMemory, unsigned long iSize, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING); 
...
//	bool LoadFile_ForVGE(const char* pszFileName, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING); 
//	bool LoadFile_ForVGE(FILE* pFilePtr, TiXmlEncoding); 
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	virtual const char* Parse( TiXmlEncoding encoding); 
...
private:
	TIXML_STRING strDataBuf;  // Loading 후 파싱되지 않은 데이터정보. 
