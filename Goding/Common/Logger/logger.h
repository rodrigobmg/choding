...
namespace util
{
	...
	public:
		...
		static const uint32	FLAG_OUTPUT		= 0x00000001;
		static const uint32	FLAG_HTML		= 0x00000002;
		static const uint32	FLAG_CONSOLE	= 0x00000004;
		static const uint32	FLAG_SCREEN		= 0x00000008;
		...
		void LogMsg(wchar_t const * str, uint32 len=0xffffffff);
		void LogF(wchar_t const * fmt, ...);

		void LogMsg(char const * str, uint32 len=0xffffffff);
	...
	private:
		...
		static const uint32	INNER_FLAG_WARNING	= 0x00020000;
		static const uint32	INNER_FLAG_ERROR	= 0x00010000;
	...
	private:
		...
		void vLog (wchar_t const * str, uint32 len);
		void vLog( char const * str, uint32 len );
